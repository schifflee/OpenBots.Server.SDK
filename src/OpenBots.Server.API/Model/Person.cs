...
namespace OpenBots.Server.SDK.Model
{
        ...
        public partial class Person :  IEquatable<Person>, IValidatableObject
    {
        ...
        public Person(Guid? id = default(Guid?), bool? isDeleted = false, string createdBy = default(string), DateTime? createdOn = default(DateTime?), string deletedBy = default(string), DateTime? deleteOn = default(DateTime?), byte[] timestamp = default(byte[]), DateTime? updatedOn = default(DateTime?), string updatedBy = default(string), string name = default(string), string firstName = default(string), string lastName = default(string), bool? isAgent = false, string company = default(string), string department = default(string), List<PersonEmail> emails = default(List<PersonEmail>), List<PersonCredential> credentials = default(List<PersonCredential>), List<EmailVerification> emailVerifications = default(List<EmailVerification>), Guid? organizationId = default(Guid?), string orgEmail = default(string))
        {
