...
namespace OpenBots.Server.SDK.Model
{
        ...
        public partial class Asset :  IEquatable<Asset>, IValidatableObject
    {
        ...
        public Asset(Guid? id = default(Guid?), bool? isDeleted = false, string createdBy = default(string), DateTime? createdOn = default(DateTime?), string deletedBy = default(string), DateTime? deleteOn = default(DateTime?), byte[] timestamp = default(byte[]), DateTime? updatedOn = default(DateTime?), string updatedBy = default(string), string name = default(string), string type = default(string), string textValue = default(string), double? numberValue = default(double?), string jsonValue = default(string), Guid? fileId = default(Guid?), long? sizeInBytes = default(long?), Guid? agentId = default(Guid?))
        {
