...
namespace OpenBots.Server.SDK.Model
{
        ...
        public partial class OrganizationUnitMember :  IEquatable<OrganizationUnitMember>, IValidatableObject
    {
        ...
        public OrganizationUnitMember(Guid? id = default(Guid?), bool? isDeleted = false, string createdBy = default(string), DateTime? createdOn = default(DateTime?), string deletedBy = default(string), DateTime? deleteOn = default(DateTime?), byte[] timestamp = default(byte[]), DateTime? updatedOn = default(DateTime?), string updatedBy = default(string), Guid? organizationId = default(Guid?), Guid? organizationUnitId = default(Guid?), Guid? personId = default(Guid?), bool? isAdministrator = false, Organization organization = default(Organization), OrganizationUnit organizationUnit = default(OrganizationUnit), Person person = default(Person))
        {
