...
namespace OpenBots.Server.SDK.Model
{
        ...
        public partial class Credential :  IEquatable<Credential>, IValidatableObject
    {
        ...
        public Credential(Guid? id = default(Guid?), bool? isDeleted = false, string createdBy = default(string), DateTime? createdOn = default(DateTime?), string deletedBy = default(string), DateTime? deleteOn = default(DateTime?), byte[] timestamp = default(byte[]), DateTime? updatedOn = default(DateTime?), string updatedBy = default(string), string name = default(string), string provider = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), string domain = default(string), string userName = default(string), string passwordSecret = default(string), string passwordHash = default(string), string certificate = default(string))
        {
