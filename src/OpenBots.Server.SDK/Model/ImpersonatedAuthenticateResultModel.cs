...
namespace OpenBots.Server.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ImpersonatedAuthenticateResultModel :  IEquatable<ImpersonatedAuthenticateResultModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImpersonatedAuthenticateResultModel" /> class.
        /// </summary>
        /// <param name="accessToken">accessToken.</param>
        /// <param name="encryptedAccessToken">encryptedAccessToken.</param>
        /// <param name="expireInSeconds">expireInSeconds.</param>
        public ImpersonatedAuthenticateResultModel(string accessToken = default(string), string encryptedAccessToken = default(string), int? expireInSeconds = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImpersonatedAuthenticateResultModel {\n");
        ...
        {
            return this.Equals(input as ImpersonatedAuthenticateResultModel);
        }

        /// <summary>
        /// Returns true if ImpersonatedAuthenticateResultModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ImpersonatedAuthenticateResultModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImpersonatedAuthenticateResultModel input)
        {
            if (input == null)
                return false;
