...
namespace OpenBots.Server.SDK.Model
{
        ...
        public partial class IntegrationEvent :  IEquatable<IntegrationEvent>, IValidatableObject
    {
        ...
        /// <param name="payloadSchema">payloadSchema.</param>
        /// <param name="isSystem">isSystem (default to true).</param>
        public IntegrationEvent(Guid? id = default(Guid?), bool? isDeleted = false, string createdBy = default(string), DateTime? createdOn = default(DateTime?), string deletedBy = default(string), DateTime? deleteOn = default(DateTime?), byte[] timestamp = default(byte[]), DateTime? updatedOn = default(DateTime?), string updatedBy = default(string), string name = default(string), string description = default(string), string entityType = default(string), string payloadSchema = default(string), bool? isSystem = true)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for IntegrationEvent and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        /// <summary>
        /// Gets or Sets PayloadSchema
        /// </summary>
        [DataMember(Name="payloadSchema", EmitDefaultValue=false)]
        ...
        public bool Equals(IntegrationEvent input)
        {
            ...
            return 
                ...
                (
                    ...
                    this.PayloadSchema.Equals(input.PayloadSchema))
                ) && 
                (
