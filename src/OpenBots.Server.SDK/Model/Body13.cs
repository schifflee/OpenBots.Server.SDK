...
namespace OpenBots.Server.SDK.Model
{
        ...
        public partial class Body13 :  IEquatable<Body13>, IValidatableObject
    {
        ...
        public Body13(string contentType = default(string), string contentDisposition = default(string), Dictionary<string, List<string>> headers = default(Dictionary<string, List<string>>), long? length = default(long?), string name = default(string), string fileName = default(string))
        {
