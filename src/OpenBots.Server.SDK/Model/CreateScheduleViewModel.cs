...
namespace OpenBots.Server.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateScheduleViewModel :  IEquatable<CreateScheduleViewModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateScheduleViewModel" /> class.
        /// </summary>
        ...
        public CreateScheduleViewModel(Guid? id = default(Guid?), string name = default(string), Guid? agentId = default(Guid?), Guid? agentGroupId = default(Guid?), string cronExpression = default(string), DateTime? lastExecution = default(DateTime?), DateTime? nextExecution = default(DateTime?), bool? isDisabled = default(bool?), Guid? projectId = default(Guid?), Guid? automationId = default(Guid?), string startingType = default(string), string status = default(string), DateTime? expiryDate = default(DateTime?), DateTime? startDate = default(DateTime?), Guid? queueId = default(Guid?), List<ParametersViewModel> parameters = default(List<ParametersViewModel>))
        {
            this.Id = id;
            this.Name = name;
        ...
        public List<ParametersViewModel> Parameters { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateScheduleViewModel {\n");
        ...
        {
            return this.Equals(input as CreateScheduleViewModel);
        }

        /// <summary>
        /// Returns true if CreateScheduleViewModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateScheduleViewModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateScheduleViewModel input)
        {
            if (input == null)
                return false;
