...
namespace OpenBots.Server.SDK.Model
{
        ...
        public partial class FileStream :  IEquatable<FileStream>, IValidatableObject
    {
        ...
        public FileStream(int? readTimeout = default(int?), int? writeTimeout = default(int?), IntPtr handle = default(IntPtr), SafeFileHandle safeFileHandle = default(SafeFileHandle), long? position = default(long?))
        {
