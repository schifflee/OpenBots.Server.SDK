...
namespace OpenBots.Server.SDK.Model
{
        ...
        public partial class AuditLog :  IEquatable<AuditLog>, IValidatableObject
    {
        ...
        public AuditLog(Guid? id = default(Guid?), bool? isDeleted = false, string createdBy = default(string), DateTime? createdOn = default(DateTime?), string deletedBy = default(string), DateTime? deleteOn = default(DateTime?), byte[] timestamp = default(byte[]), DateTime? updatedOn = default(DateTime?), string updatedBy = default(string), Guid? objectId = default(Guid?), string serviceName = default(string), string methodName = default(string), string parametersJson = default(string), string exceptionJson = default(string), string changedFromJson = default(string), string changedToJson = default(string))
        {
            this.Id = id;
