...
namespace OpenBots.Server.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmailViewModel :  IEquatable<EmailViewModel>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailViewModel {\n");
        ...
        {
            return this.Equals(input as EmailViewModel);
        }

        /// <summary>
        /// Returns true if EmailViewModel instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailViewModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailViewModel input)
        {
            if (input == null)
                return false;
