...
namespace OpenBots.Server.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateEmailViewModel :  IEquatable<UpdateEmailViewModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEmailViewModel" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateEmailViewModel {\n");
        ...
        {
            return this.Equals(input as UpdateEmailViewModel);
        }

        /// <summary>
        /// Returns true if UpdateEmailViewModel instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateEmailViewModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateEmailViewModel input)
        {
            if (input == null)
                return false;
