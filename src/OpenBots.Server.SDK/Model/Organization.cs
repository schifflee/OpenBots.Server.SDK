...
namespace OpenBots.Server.SDK.Model
{
        ...
        public partial class Organization :  IEquatable<Organization>, IValidatableObject
    {
        ...
        public Organization(Guid? id = default(Guid?), bool? isDeleted = false, string createdBy = default(string), DateTime? createdOn = default(DateTime?), string deletedBy = default(string), DateTime? deleteOn = default(DateTime?), byte[] timestamp = default(byte[]), DateTime? updatedOn = default(DateTime?), string updatedBy = default(string), string name = default(string), string description = default(string), List<OrganizationUnit> units = default(List<OrganizationUnit>), List<AccessRequest> accessRequests = default(List<AccessRequest>), List<OrganizationMember> members = default(List<OrganizationMember>), List<OrganizationSetting> settings = default(List<OrganizationSetting>), Guid? organizationId = default(Guid?))
        {
