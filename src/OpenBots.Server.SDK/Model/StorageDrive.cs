...
namespace OpenBots.Server.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StorageDrive :  IEquatable<StorageDrive>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageDrive" /> class.
        /// </summary>
        ...
        /// <param name="maxStorageAllowedInBytes">maxStorageAllowedInBytes.</param>
        /// <param name="isDefault">isDefault.</param>
        public StorageDrive(Guid? id = default(Guid?), bool? isDeleted = false, string createdBy = default(string), DateTime? createdOn = default(DateTime?), string deletedBy = default(string), DateTime? deleteOn = default(DateTime?), byte[] timestamp = default(byte[]), DateTime? updatedOn = default(DateTime?), string updatedBy = default(string), string name = default(string), string fileStorageAdapterType = default(string), Guid? organizationId = default(Guid?), string storagePath = default(string), long? storageSizeInBytes = default(long?), long? maxStorageAllowedInBytes = default(long?), bool? isDefault = default(bool?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for StorageDrive and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            this.MaxStorageAllowedInBytes = maxStorageAllowedInBytes;
        ...
        /// <summary>
        /// Gets or Sets MaxStorageAllowedInBytes
        /// </summary>
        [DataMember(Name="maxStorageAllowedInBytes", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MaxStorageAllowedInBytes: ").Append(MaxStorageAllowedInBytes).Append("\n");
        ...
        {
            return this.Equals(input as StorageDrive);
        }

        /// <summary>
        /// Returns true if StorageDrive instances are equal
        /// </summary>
        /// <param name="input">Instance of StorageDrive to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StorageDrive input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MaxStorageAllowedInBytes == input.MaxStorageAllowedInBytes ||
                    (this.MaxStorageAllowedInBytes != null &&
                    this.MaxStorageAllowedInBytes.Equals(input.MaxStorageAllowedInBytes))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MaxStorageAllowedInBytes != null)
                    hashCode = hashCode * 59 + this.MaxStorageAllowedInBytes.GetHashCode();
