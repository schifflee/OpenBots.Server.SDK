...
namespace OpenBots.Server.SDK.Model
{
        ...
        public partial class Body2 :  IEquatable<Body2>, IValidatableObject
    {
        ...
        public Body2(Guid? id = default(Guid?), string name = default(string), string type = default(string), string textValue = default(string), double? numberValue = default(double?), string jsonValue = default(string), Guid? fileId = default(Guid?), byte[] _file = default(byte[]), string driveName = default(string))
        {
            this.Id = id;
            this.Name = name;
            this.Type = type;
