...
namespace OpenBots.Server.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class QueueItemAttachment :  IEquatable<QueueItemAttachment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueItemAttachment" /> class.
        /// </summary>
        ...
        public QueueItemAttachment(Guid? id = default(Guid?), bool? isDeleted = false, string createdBy = default(string), DateTime? createdOn = default(DateTime?), string deletedBy = default(string), DateTime? deleteOn = default(DateTime?), byte[] timestamp = default(byte[]), DateTime? updatedOn = default(DateTime?), string updatedBy = default(string), Guid? queueItemId = default(Guid?), Guid? fileId = default(Guid?), long? sizeInBytes = default(long?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueueItemAttachment {\n");
        ...
        {
            return this.Equals(input as QueueItemAttachment);
        }

        /// <summary>
        /// Returns true if QueueItemAttachment instances are equal
        /// </summary>
        /// <param name="input">Instance of QueueItemAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueItemAttachment input)
        {
            if (input == null)
                return false;
