...
namespace OpenBots.Server.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ConfigurationValue :  IEquatable<ConfigurationValue>, IValidatableObject
    {
        /// <summary>
        ...
        public ConfigurationValue(Guid? id = default(Guid?), bool? isDeleted = false, string createdBy = default(string), DateTime? createdOn = default(DateTime?), string deletedBy = default(string), DateTime? deleteOn = default(DateTime?), byte[] timestamp = default(byte[]), DateTime? updatedOn = default(DateTime?), string updatedBy = default(string), string name = default(string), string value = default(string), string description = default(string), string uiHint = default(string), string validationRegex = default(string))
        {
            this.Id = id;
        ...
        public bool Equals(ConfigurationValue input)
        {
            ...
            return 
                ...
                (
                    this.UiHint == input.UiHint ||
                    (this.UiHint != null &&
                    this.UiHint.Equals(input.UiHint))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UiHint != null)
                    hashCode = hashCode * 59 + this.UiHint.GetHashCode();
