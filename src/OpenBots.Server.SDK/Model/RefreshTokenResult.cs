...
namespace OpenBots.Server.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RefreshTokenResult :  IEquatable<RefreshTokenResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefreshTokenResult" /> class.
        /// </summary>
        /// <param name="accessToken">accessToken.</param>
        /// <param name="encryptedAccessToken">encryptedAccessToken.</param>
        /// <param name="expireInSeconds">expireInSeconds.</param>
        public RefreshTokenResult(string accessToken = default(string), string encryptedAccessToken = default(string), int? expireInSeconds = default(int?))
        {
        ...
        {
            return this.Equals(input as RefreshTokenResult);
        }

        /// <summary>
        /// Returns true if RefreshTokenResult instances are equal
        /// </summary>
        /// <param name="input">Instance of RefreshTokenResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefreshTokenResult input)
        {
            if (input == null)
                return false;
