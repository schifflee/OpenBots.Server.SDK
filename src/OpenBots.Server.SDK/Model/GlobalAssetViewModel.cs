...
namespace OpenBots.Server.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GlobalAssetViewModel :  IEquatable<GlobalAssetViewModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobalAssetViewModel" /> class.
        /// </summary>
        ...
        public GlobalAssetViewModel(Guid? id = default(Guid?), string name = default(string), string type = default(string), string textValue = default(string), double? numberValue = default(double?), string jsonValue = default(string), Guid? fileId = default(Guid?), long? sizeInBytes = default(long?), string driveName = default(string), byte[] _file = default(byte[]))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GlobalAssetViewModel and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for GlobalAssetViewModel and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlobalAssetViewModel {\n");
        ...
        {
            return this.Equals(input as GlobalAssetViewModel);
        }

        /// <summary>
        /// Returns true if GlobalAssetViewModel instances are equal
        /// </summary>
        /// <param name="input">Instance of GlobalAssetViewModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlobalAssetViewModel input)
        {
            if (input == null)
                return false;
